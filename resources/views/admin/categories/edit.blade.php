        ...
        <div class="team">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              <h2 class="text-center title">Edita tu categoría</h2>
              ...
              <form class="contact-form" action="{{ url('/admin/categories/'.$categoria->id.'/edit') }}" method="POST">
                @csrf
                <div class="row">
                  <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-4 ml-auto mr-auto text-center">
                  ...
                  <a href="{{ url('/admin/categories/') }}" class="btn btn-danger btn-raised">
                  Cancelar</a>
                </div>
              </div>
            </form>
